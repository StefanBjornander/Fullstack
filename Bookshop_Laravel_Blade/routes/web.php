...
Route::get("/search", "MainMenuController@search");
Route::get("/result", "MainMenuController@result");
Route::get("/add", "MainMenuController@add");
Route::get("/buy", "MainMenuController@buy");
Route::get("/clear", "MainMenuController@clear");
